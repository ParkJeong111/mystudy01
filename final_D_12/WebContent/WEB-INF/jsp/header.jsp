 ...
 .submenumore li{
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <input type="text" class="form-controla" placeholder="검색어를 입력해주세요" style="margin-left: 100px">
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="talklist" class="nav-link">게시판</a></li>
          ...
          <li class="nav-item cta"><a href="login" class="nav-link"><span>로그인</span></a>
                ...
                <li class="nav-link" ><a href="my_myinfo">내정보</a></li>
