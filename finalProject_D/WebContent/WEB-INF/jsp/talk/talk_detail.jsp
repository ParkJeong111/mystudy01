...
.view_info_comment .comment_box .comment_date{position:relative;margin-top:5px}
...
<div class="view_detail container" style="padding-top: 58px;">
	...
	<!-- 신고하기 모달창 시작 -->
	<div id="modalReportBox" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style = "font-family: Jua;">
			...
			<div class="view_info_comment view_contents" id="comment_box">
				<section>
					...
					<div class="comment_text_area">
					    <form role="commentform" id="talkCommentForm" name="talkCommentForm" method="post" action="boardCommentInsert">
					    ...
					    <div class="comment_upload_box clearfix">
					        <a id="boardCommentInsert" class="comm_btn btn_comm" style="cursor: pointer;">등록하기</a>
             ...
             <div class="comment_list_box tcm_best tcm_box clearfix tcm_box286297" id="tcm_box286297">
                <div class="comment_box">
                    <p class="comment_date">
                        <span>${e.mnickname}</span> <span>${e.bcdate}</span>
                    </p>
                    <p class="comment_txt">
                      ${e.bccontent} 
                    </p>
...
$(document).ready(function(){
  ...
  $('#openModalBtn1').on('click', function(){
	  console.log('모달이다.')
	  $('#modalReportBox').modal('show');
	  });
	  // 모달 안의 취소 버튼에 이벤트를 건다.
	  $('#closeModalBtn2').on('click', function(){
	  $('#modalReportBox').modal('hide');
	  });
