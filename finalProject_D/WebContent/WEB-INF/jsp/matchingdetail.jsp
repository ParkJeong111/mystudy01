		...
		<section>
			<div class="view_profile clearfix">
				...
				<div class="profile_info col-md-4" >
					<dl class="clearfix">
						<dt>
							<span class="ico_pic ico_pic1">제목</span> <br>${list.mbtitle}<br>
							<span class="ico_pic ico_pic1">위치</span> <br>${list.mblocation}<br>
						</dt>
						<!-- 
						<dd>
							<h2>서울</h2>
				...
				<!-- 업체 지도 -->
				<!--  <div class="profile_info col-md-4">
					<span class="ico_pic ico_pic1">제목</span> <br>출조<br>
					<span class="ico_pic ico_pic1">위치</span> <br>서울<br>
				</div>-->
				...
				<span style="display:block; font-size: 20px; font-family: Jua;"><b>신청하기</b></span></a>
				</div>
				</a>
				<%-- <img
					src="${pageContext.request.contextPath}/resources/images/천성낚시터.JPG"
		...
		<div id="view_ticket"
			...
			<section>
				...
				<div class="view_box info_view_sty6">
					...
					<hr>
						<p class="view_box_title">
						매칭 신청한 아이디<span class="count_txt"><br>juju/</span>
					</p>
				</div>
				<!-- 어종 정보 시작 -->
				<!-- 서비스 정보 시작 -->
