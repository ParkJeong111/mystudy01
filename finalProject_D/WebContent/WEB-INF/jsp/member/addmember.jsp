...
<head>
<script
	src="//developers.kakao.com/sdk/${pageContext.request.contextPath}/resources/js/kakao.min.js"></script>
<style>
			...
			<div class="row block-9">
				<div class="col-md-6 pr-md-5">
					<form action="./" style="left: 300px;">
						...
						<div class="form-group">
							...
							<div><input type="text" class="form-control" placeholder="  아이디"
								style="z-index: 1; width: 70%; float: left;"><input type="button" value="중복체크" style="z-index: 1; width: 20%; float: right;"></div>
						</div>
						<div class="form-group">
							<img
						...
						<div class="form-group">
							<img
								...
								style="width: 34px; height: 26px; z-index: 2; position: relative; right:-90%; top: 38px;">
							<input type="password" class="form-control"
								placeholder="  비밀번호 확인" style="z-index: 1;">
						</div>
						<div class="form-group">
							<img
                ...
                <div class="agree_box" >
                    <label class="clearfix">
                        <input type="checkbox" name="termsAgreement" value="Y"/>
                        <ins></ins>
                        <span><a href="/more/policy_info/agreement" target="_blank">이용약관 동의</a> (필수)<em>광고성 정보 수신동의 포함</em></span>
                    </label>
                    <label class="clearfix">
                        <input type="checkbox" name="termsRequiredPrivacy" value="Y" />
                        <ins></ins>
                        <span><a href="/more/policy_info/personal" target="_blank">개인정보 수집 및 이용동의</a>(필수)<em>예약 및 서비스 이용을 위한 개인정보 수집</em></span>
                    </label>
                </div>
                -->
						</div>
