		...
		<div class="container"style="margin: auto;width: 100%">
			<div class="row d-flex mb-5 contact-info">
				<div class="col-md-6 mb-4" style="margin-left: 7%;">
					<h2 class="h4" style="margin-top: -100px; color: #333333">
						...
						width="80px;" style="font-family: Gugi;font-size: 75px;">고기자바.</strong>
					</h2>
				</div>
				...
				<div class="col-md-6 pr-md-5">
					<form action="logincheck">
						...
						class="ico_login_nikname" style = "width: 34px; height: 26px; z-index: 49; position:relative; right:-85%; top: 38px;">
							<input id="mid" name="mid" type="text" class="form-control" placeholder="  아이디를 입력해주세요" value="" style="font-size: 25px;">
						</div>
						<div class="form-group">
						...
						class="ico_login_password" style = "width: 34px; height: 26px; z-index: 50; position:relative; right:-85%; top: 38px;">
							<input id="mpwd" name="mpwd" type="password" class="form-control"
								placeholder="  비밀번호를 입력해주세요" value=""  style="font-size: 25px;">
						</div>
		
						<div class="form-group" style="text-align: center;">
							<input type="submit" value="로그인"  style="font-size: 25px;width: 90%;"
								class="btn btn-primary py-3 px-5" ">
						</div>
						<div class="password_find">
							<a href="passwordfind" style="margin-left: 35%; font-weight: bold;font-size: 20px;">비밀번호를 잊으셨나요?</a>
						</div>
						<hr>
						<div class="box_area">
							<div class="full_btn_gray">
								<a href="addmember" style = "font-weight: bold;font-size: 20px;">회원 가입하기</a>
							</div>
							<hr>
