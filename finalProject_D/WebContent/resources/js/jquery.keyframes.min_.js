(function() {
		...
		generate : function(t) {
			...
			if (r.length > 0) {
				...
				n = $("*").filter(
						function() {
							this.style[""
									+ $.keyframe.getVendorPrefix().slice(1, -1)
									+ "AnimationName"] === s
						});
				n.each(function() {
					var e, t;
	...
	$.fn.resetKeyframe = function(e) {
		var i = $(this).css(r + t, n).css(r + "animation", "none");
		if (e) {
			setTimeout(e, 1)
		}
	};
	...
	$.fn.playKeyframe = function(e, i) {
		...
		u = e.delay;
		l = e.repeat;
		s = "" + e.name + " " + a + "ms " + e.timingFunction + " " + u + "ms "
				+ l + " " + e.direction + " " + e.fillMode;
		i = e.complete;
		o = r + "animation";
		f = [ "webkit", "moz", "MS", "o", "" ];
		...
		this.each(function() {
			var u = $(this).addClass("boostKeyframe").css(r + t, n).css(o, s)
	...
	e({
		id : "boost-keyframe"
	}).append(" .boostKeyframe{" + r + "transform:scale3d(1,1,1);}")
}).call(this)
